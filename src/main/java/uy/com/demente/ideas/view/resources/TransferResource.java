...
import uy.com.demente.ideas.business.exceptions.InsufficientBalanceException;
import uy.com.demente.ideas.business.exceptions.InvalidSessionException;
import uy.com.demente.ideas.business.exceptions.MakeTransferException;
import uy.com.demente.ideas.business.exceptions.TransactionNotFoundException;
import uy.com.demente.ideas.business.exceptions.TypeCoinDontMatchesException;
import uy.com.demente.ideas.business.exceptions.WalletMatchesException;
import uy.com.demente.ideas.business.exceptions.WalletNotFoundException;
import uy.com.demente.ideas.business.services.SecurityService;
import uy.com.demente.ideas.business.services.TransferService;
...
public class TransferResource {
	...
	public ResponseEntity<TransferDTO> addTransfer(@RequestHeader("Session-Token") String sessionToken,
			@RequestBody TransferDTO transferDTO) throws TypeCoinDontMatchesException {
	...
	public ResponseEntity<ListTransfersDTO> findByFilter(
		...
		try {
			...
			logger.info("[GET_ALL_TRANSFERS_FILTER] - It will try to return all system transfers filtered by: from date"
					+ fromTimestamp.toString() + ", to date: " + toTimestamp.toString() + ", origin wallet: "
					+ originWallet);
			...
			logger.error("[GET_ALL_TRANSFERS_FILTER] [ERROR] - Internal system error when trying to get transfers ");
			return new ResponseEntity<>(null, HttpStatus.INTERNAL_SERVER_ERROR);
		}
	}
