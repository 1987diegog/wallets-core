...
import uy.com.demente.ideas.business.services.WalletService;
...
public class UserResource {
	...
	public ResponseEntity<UserDTO> update(@RequestBody UserDTO userDTO) {
		...
		try {
			...
			logger.error("[UPDATE_USER] [ERROR] - To try update user data, id: " + userDTO.getIdUser());
	...
	public ResponseEntity<UserDTO> findById(@PathVariable("id") Long id) {
		...
		try {
			...
			logger.info("[FIND_BY_USER_ID] - User not found id: " + id);
			return new ResponseEntity<>(null, HttpStatus.NOT_FOUND);
		} catch (Exception e) {
			logger.error("[FIND_BY_USER_ID] [ERROR] - To try get user with id: " + id);
			return new ResponseEntity<>(null, HttpStatus.INTERNAL_SERVER_ERROR);
		}
	}
	...
	public ResponseEntity<ListUsersDTO> findAll() {
		...
		try {
			...
			logger.error("[GET_ALL_USERS] [ERROR] - Internal system error when trying to get all users");
			return new ResponseEntity<>(null, HttpStatus.INTERNAL_SERVER_ERROR);
		}
	}
	...
	public ResponseEntity<ListWalletsDTO> findWalletsByUser(@PathVariable("id") Long id) {
		...
		try {
			...
			logger.error(
					"[FIND_ALL_WALLETS_BY_USER] [ERROR] - Internal system error when trying to get all user wallets");
			return new ResponseEntity<>(null, HttpStatus.INTERNAL_SERVER_ERROR);
		}
	}
	...
	public ResponseEntity<String> delete(@PathVariable("id") Long id) {
		...
		try {
			...
			logger.error("[DELETE_USER] [ERROR] - Internal system error when trying to delete user whit id: " + id);
			return new ResponseEntity<>(null, HttpStatus.INTERNAL_SERVER_ERROR);
		}
	}
}
